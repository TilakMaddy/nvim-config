...
require('lazy').setup({
  ...
  -- },
  {
    ...
    config = function()
      ...
      -- @Tilak added so that I can choose an option by pressing enter instead of <C-y>
  ...
  { -- Autoformat
    ...
    opts = {
      ...
      formatters_by_ft = {
        lua = { 'stylua' },
        -- I don't know which one that's why I'm adding both
        ['c++'] = { 'clang-format' }, -- also installed above in mason keys
        cpp = { 'clang-format' },
